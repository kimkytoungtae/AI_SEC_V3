...
def init_server():
    ...
    eth_graph = ["chart/eth_mse_mae.png", "chart/btc_scatter.png"]
    xrp_graph = ["chart/xrp_mse_mae.png", "chart/btc_scatter.png"]
   # 모델 , 에러율 사전 처리
init_server()
...
def input_request(coin_name="BTC",time_gap=1):
    ...
    print(type(y_predarr))
    #y_predarr = [str(d) for d in y_predarr]
